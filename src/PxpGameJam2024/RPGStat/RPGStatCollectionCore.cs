...
namespace Pixpil.RPGStatSystem {
    ...
    public class RPGStatCollectionCore {
        ...
        private Dictionary<string, RPGStat> _statDict = new ();
        ...
        /// </summary>
        public bool ContainStat( string statTypeId ) => StatDict.ContainsKey( statTypeId );
        ...
        public void AddStatModifier( string targetId, RPGStatModifier mod, bool update ) {
            if ( ContainStat( targetId ) ) {
                if ( GetStat( targetId ) is IStatModifiable modStat ) {
