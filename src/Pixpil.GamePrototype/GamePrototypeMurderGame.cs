...
public class GamePrototypeMurderGame : IMurderGame, IShaderProvider {
    ...
    public void Initialize() {
        ...
        Game.Input.RegisterAxes( MurderInputAxis.Movement, GamepadAxis.LeftThumb, GamepadAxis.RightThumb,
            GamepadAxis.Dpad );
        ...
        Game.Input.Register( MurderInputAxis.UiTab,
            new InputButtonAxis( Buttons.LeftShoulder, Buttons.LeftShoulder, Buttons.RightShoulder,
    ...
    public string[] Shaders => _myShaders;
    private readonly string[] _myShaders = [
        "sprite-mrt",
        "light-point",
        "SpriteEffect"
    ];
